...
impl EnvConfiguration {
    pub fn init_config() {
        ...
        CONFIG.get_or_init(|| EnvConfiguration {
            main_database_url: env::var("MAIN_DATABASE_URL").unwrap_or("postgres://postgres:postgres@localhost/postgres".to_string()),
            database_url: env::var("DATABASE_URL").unwrap_or("postgres://postgres:postgres@localhost/database".to_string()),
            ...
            mail_username: env::var("MAIL_USERNAME").unwrap_or("example@example.example".to_string()),
            ...
            dir_product_images: env::var("DIR_PRODUCT_IMAGES").unwrap_or("product_images".to_string()),
        });
    }
}
